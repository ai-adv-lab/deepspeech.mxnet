    ...
    def __iter__(self):
        ...
        for k in range(int(self.count / self.batch_size)):
            ...
            if self.is_first_epoch:
                train_data_set = self.datagen.prepare_minibatch(audio_paths, texts, overwrite=True)
            else:
                train_data_set = self.datagen.prepare_minibatch(audio_paths, texts, overwrite=False)
